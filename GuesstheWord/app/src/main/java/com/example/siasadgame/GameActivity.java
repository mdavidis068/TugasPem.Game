...
public class GameActivity extends Activity implements OnInitListener {
    ...
    static final int answer_line_width = 10;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //init sound effects
        Helper.InitSounds(this, new String[]{"click", "correct", "wrong", "tip", "sapi", "bunglon", "gajah", "kelelawar", "macan",
                "ayam", "gurita", "jerapah", "katak", "kelinci"});
...
//                soundcorrect();
    ...
    public void onBackPressed() {
        saveCurrentGame();
        Intent menu_intent = new Intent(GameActivity.this, MenuAwal.class);
