...
public class GameActivity1 extends Activity implements OnInitListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //init sound effects
        Helper.InitSounds(this, new String[]{"click", "correct", "wrong", "tip", "anggrek", "edelweis", "lavender", "matahari",
                "mawar", "melati", "raflesia", "sepatu", "teratai"});
    ...
    String[] getImagesFromAssets() {
        ...
        try {
            img_files = getAssets().list("pictures2");
    ...
    void loadImage(String name) {
        try {
            InputStream ims = getAssets().open("pictures2/" + name);
...
//                soundcorrect();
                ...
                if (cur_image < images.length - 1) {
                    ...
                    Intent end_game = new Intent(GameActivity1.this, EndActivity.class);
    ...
    public void onBackPressed() {
        saveCurrentGame();
        Intent menu_intent = new Intent(GameActivity1.this, MenuAwal.class);
