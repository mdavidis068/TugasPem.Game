...
public class GameActivity2 extends Activity implements OnInitListener {
    ...
    Point letter_button_size = new Point((int) Helper.getScreenSize().x / 10, (int) Helper.getScreenSize().x / 10);
    ...
    Point tip_button_size = new Point((int) Helper.getScreenSize().x / 10, (int) Helper.getScreenSize().x / 10);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //init sound effects
        Helper.InitSounds(this, new String[]{"click", "correct", "wrong", "tip", "alpukat", "anggur", "apel", "jeruk", "kelengkeng",
        "manggis", "pisang", "salak", "semangka", "stroberi"});
    ...
    void generateNewLevel() {
        ...
        guess_text.setText("Soal" + " " + cur_image );
        letters_in_answer = 0;
        correct_answer = getUpperNameWithoutExtensionAndSpaces(images[cur_image]);
        fillLetterButtons(correct_answer);
        generateAnswerButtons(getNameWithoutExtension(images[cur_image]));
    ...
    void initViews() {
        ...
        guess_text.setTextSize(Helper.getScreenSize().x / 30);
        guess_text.setText("Soal" + " " + cur_image );
        money_text = (TextView) findViewById(R.id.money_text);
        money_text.setTypeface(Typeface.SERIF);
        money_text.setTextSize(Helper.getScreenSize().x / 30);
        money_text.setText(" " + money);
        initLinkingAndTipLists();
        //load Admob Ads
    }
    ...
    String[] getImagesFromAssets() {
        ...
        try {
            img_files = getAssets().list("pictures3");
    ...
    void loadImage(String name) {
        try {
            InputStream ims = getAssets().open("pictures3/" + name);
...
//                soundcorrect();
                ...
                if (cur_image < images.length - 1) {
                    ...
                    Intent end_game = new Intent(GameActivity2.this, EndActivity.class);
    ...
    public void onBackPressed() {
        saveCurrentGame();
        Intent menu_intent = new Intent(GameActivity2.this, MenuAwal.class);
    ...
    void ShowToast(Toast toast, String message, int gravity, Point pos) {
        ...
        View layout = inflater.inflate(R.layout.jawabbenar,
    ...
    void HideToast(Toast toast, String message, int gravity, Point pos) {
        LayoutInflater inflater = getLayoutInflater();
        View layout = inflater.inflate(R.layout.jawabsalah,
                (ViewGroup) findViewById(R.id.toast_layout_root));
        // layout.setLayoutParams(lp);
        TextView text = (TextView) layout.findViewById(R.id.toast_text);
        text.setTextSize(Helper.getScreenSize().x / 30);
    ...
    public void soundcorrect() {
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.yee);
        if (mediaPlayer != null) {
            mediaPlayer.start();
            mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                @Override
